...
class plugin:
    ...
    def updateCommonElements(self, data, name, patientid, privatetags):
        ...
        self.updateElement(data, 'InstitutionCodeSequence', '')
        self.updateElement(data, 'ReferringPhysicianIdentificationSequence', '')
        self.updateElement(data, 'ConsultingPhysicianName', '')
        self.updateElement(data, 'ConsultingPhysicianIdentificationSequence', '')
        self.updateElement(data, 'PhysiciansOfRecordIdentificationSequence', '')
        self.updateElement(data, 'PerformingPhysicianIdentificationSequence', '')
        self.updateElement(data, 'PhysiciansReadingStudyIdentificationSequence', '')
        self.updateElement(data, 'OperatorIdentificationSequence', '')
        self.updateElement(data, 'IssuerOfPatientID', '')
        self.updateElement(data, 'TypeOfPatientID', '')
        self.updateElement(data, 'IssuerOfPatientIDQualifiersSequence', '')
        self.updateElement(data, 'SourcePatientGroupIdentificationSequence', '')
        self.updateElement(data, 'GroupOfPatientsIdentificationSequence', '')
        self.updateElement(data, 'PatientBirthDateInAlternativeCalendar', '')
        self.updateElement(data, 'PatientDeathDateInAlternativeCalendar', '')
        self.updateElement(data, 'PatientAlternativeCalendar', '')
        self.updateElement(data, 'OtherPatientIDsSequence', '')
        self.updateElement(data, 'PatientSizeCodeSequence', '')
        self.updateElement(data, 'Occupation', '')
        self.updateElement(data, 'SmokingStatus', '')
        self.updateElement(data, 'PregnancyStatus', '')
        self.updateElement(data, 'PatientSpeciesDescription', '')
        self.updateElement(data, 'PatientSpeciesCodeSequence', '')
        self.updateElement(data, 'PatientSexNeutered', '')
        self.updateElement(data, 'PatientBreedDescription', '')
        self.updateElement(data, 'PatientBreedCodeSequence', '')
        self.updateElement(data, 'ResponsiblePerson', '')
        self.updateElement(data, 'ResponsiblePersonRole', '')
        self.updateElement(data, 'ResponsibleOrganization', '')
        self.updateElement(data, 'PatientComments', '')
